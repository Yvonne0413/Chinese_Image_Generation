...
def display_array(data):  # array -> plot 2D
    if len(data.shape) == 4:
        data = data[0, :, :, 0]  # remove the dimensions 4 dimensions->2 dimensions first:size of the batch last: rgb size one
